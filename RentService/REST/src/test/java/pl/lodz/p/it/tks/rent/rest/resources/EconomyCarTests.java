...
@Testcontainers
public class EconomyCarTests extends AbstractContainer {
    ...
    public void getAllEconomyCarsTest() {
        ...
        Assertions.assertEquals(economyCars.getJSONObject(lastIndex).getString("id"), testCar3.getString("id"));
        Assertions.assertEquals(economyCars.getJSONObject(lastIndex - 1).getString("id"), testCar2.getString("id"));
        Assertions.assertEquals(economyCars.getJSONObject(lastIndex - 2).getString("id"), testCar1.getString("id"));
    }
