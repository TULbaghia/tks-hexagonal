...
import pl.lodz.p.it.tks.rent.applicationports.infrastructure.user.customer.UpdateCustomerPort;
...
import pl.lodz.p.it.tks.rent.domainmodel.user.customer.SpecialCustomer;
